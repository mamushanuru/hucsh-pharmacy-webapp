      ...
      <div className="row mb-4">
        ...
        <div className="col-md-4 mb-3">
          ...
          >
            ...
            {Array.from(new Set(medicines.map((med) => med.category_name))).map((category) => (
          ...
          <div className="row">
            ...
            <div className="col-md-2">
              <select
                ...
                onChange={(e) =>
                  setNewMedication({ ...newMedication, category_id: e.target.value })
                }
              >
                <option value={1}>Anti-Infectives</option>
                <option value={2}>Cardiovascular</option>
                <option value={3}>Gastrointestinal</option>
                <option value={4}>CNS</option>
                <option value={5}>Musculoskeletal</option>
            ...
            <div className="col-md-2">
              <select
                ...
                onChange={(e) =>
                  setNewMedication({ ...newMedication, availability: e.target.value })
                }
              >
                ...
                {editMedication?.medication_id === medicine.medication_id ? (
                  <form onSubmit={handleUpdateMedication}>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setEditMedication({ ...editMedication, category_id: e.target.value })
                      }
                    >
                      <option value={1}>Anti-Infectives</option>
                      <option value={2}>Cardiovascular</option>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setEditMedication({ ...editMedication, availability: e.target.value })
                      }
                    >
                      <option value={1}>Available</option>
                      <option value={0}>Unavailable</option>
